---
title: "Autoregressive_Models_Part_2"
format: html
editor: visual
---
...
Fit a nonlinear AR model using k nearest neighbors on the `gtemp` dataset. Compute its sum of squared residuals and compare it to that of a linear AR model. How about its test error?
