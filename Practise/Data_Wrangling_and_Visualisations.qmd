...
It says that there are gaps in the time index. This is unsurprising, because of daylight savings. To see where the gaps are, use `scan_gaps()`:
...
Now let us fill the gaps and make the seasonal plot.
